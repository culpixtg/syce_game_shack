...
, function(n, e, t) {
            ...
            return x.a.wrap(function(n) {
                for (; ; )
                    ...
                    case 16:
                        ...
                        o = 0; o <= S.a.numScreenshots - 1; o++)
                            i = document.createElement("div"),
                            i.className = "bullet".concat(0 === o ? " active" : ""),
                    ...
                    case 31:
                        ...
                        a = function(n) {
                            var e = h()
                              , t = new Image;
                            t.src = "".concat(B, "screenshots/").concat(n + 1, "-small.jpg").concat(I),
                            e.appendChild(t),
                            e.setAttribute("data-idx", n),
                            1 === n ? e.className = "".concat(L, " right") : n === S.a.numScreenshots - 1 ? e.className = "".concat(L, " left") : e.className = "".concat(L, " inactive"),
                            w.appendChild(e)
                        }
                        ,
                        c = 1; c <= S.a.numScreenshots - 1; c++)
                            a(c);
                        s();
                    case 36:
                    case "end":
        ...
        return c = i(x.a.mark(function n() {
            ...
            return x.a.wrap(function(n) {
                for (; ; )
                    switch (n.prev = n.next) {
                    case 0:
                        if (e = 1e3 * S.a.slideshowInterval,
                        t = w.querySelector("#slideshow-images .right"),
                        o = t.getAttribute("data-idx") << 0,
                        ...
                        return i = Date.now(),
                        n.next = 7,
                        f("".concat(B, "screenshots/").concat(o + 1, ".jpg").concat(I));
                    case 7:
                        r = n.sent,
                        t.querySelector("img").src = r.src,
                        t.setAttribute("fullImageLoaded", !0),
                        ...
                        a = Date.now() - i,
                        a > e ? l() : window.slideShowTimeoutID = window.setTimeout(l, e - a),
                        n.next = 19;
                        break;
                    case 16:
                        clearTimeout(window.slideShowMoveTransitionID),
    ...
    function d(n) {
        ...
        w.querySelectorAll(".image").forEach(function(n) {
            n.className === "".concat(L, " left") && (n.className = "".concat(L, " fromLeft")),
            n.className === "".concat(L, " right") && (n.className = "".concat(L, " fromRight")),
            -1 === n.className.indexOf("inactive") && (n.className += " inactive")
        }),
        w.querySelector('[data-idx="'.concat(k, '"]')).className = "".concat(L, " middle"),
        w.querySelector('[data-idx="'.concat(e, '"]')).className = "".concat(L, " left"),
        w.querySelector('[data-idx="'.concat(t, '"]')).className = "".concat(L, " right"),
    ...
    function u() {
        ...
        e > S.a.fullImageMaxHeight && (e = S.a.fullImageMaxHeight,
        t = e * v / n);
    ...
    function h() {
        ...
        return n.className = L,
        n
    }
    e.a = r;
    var m, p, g, w, v, y, b = t(10), x = t.n(b), S = t(0), L = "image", k = 0, E = !1, I = S.a.screenshotsVersion ? "?v".concat(S.a.screenshotsVersion) : "", C = window.location.pathname.substring(0, window.location.pathname.lastIndexOf("/")), T = window.location.hostname.endsWith("game-cdn.poki.com") || window.location.hostname.endsWith(".poki-gdn.com"), B = T ? "/cdn-cgi/image/f=auto,quality=78".concat(C, "/") : "";
...
, function(n, e, t) {
    ...
    h.innerHTML = '<div class="bounce0"></div><div class="bounce1"></div><div class="bounce2">',
    h.setAttribute("class", "spinner");
    ...
    n.exports = function(n) {
        ...
        e.i = function(n, t) {
            ...
            for (i = 0; i < n.length; i++) {
                var a = n[i];
                null != a[0] && o[a[0]] || (t && !a[2] ? a[2] = t : t && (a[2] = "(" + a[2] + ") and (" + t + ")"),
                e.push(a))
            }
        }
        ,
...
, function(n, e, t) {
        ...
        for (var t = 0; t < n.length; t++) {
            ...
            if (i) {
                ...
                for (; r < o.parts.length; r++)
                    i.parts.push(u(o.parts[r], e))
            } else {
                for (var a = [], r = 0; r < o.parts.length; r++)
                    a.push(u(o.parts[r], e));
                p[o.id] = {
                    id: o.id,
                    refs: 1,
                    parts: a
    ...
    function r(n, e) {
        ...
        var o = x[x.length - 1];
        if ("top" === n.insertAt)
            o ? o.nextSibling ? t.insertBefore(e, o.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild),
            x.push(e);
    ...
    function u(n, e) {
        ...
        if (e.transform && n.css) {
            if (!(r = "function" == typeof e.transform ? e.transform(n.css) : e.transform.default(n.css)))
                return function() {}
                ;
            n.css = r
        }
        if (e.singleton) {
            ...
            n.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = c(e),
            o = m.bind(null, t, e),
            i = function() {
                a(t),
    ...
    function m(n, e, t) {
        ...
        (e.convertToAbsoluteUrls || r) && (o = S(o)),
...
, function(n, e) {
    n.exports = function(n) {
        ...
        return n.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(n, e) {
            ...
            if (/^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(i))
                return n;
            var r;
            return r = 0 === i.indexOf("//") ? i : 0 === i.indexOf("/") ? t + i : o + i.replace(/^\.\//, ""),
...
, function(n, e, t) {
    ...
    function o() {
        ...
        t > w.a.maxRatio ? d.style.width = "".concat(e * w.a.maxRatio, "px") : t < w.a.minRatio && (d.style.height = "".concat(n / w.a.minRatio, "px"));
        var o = d.getBoundingClientRect();
        d.style.marginLeft = "".concat(-.5 * o.width, "px"),
        d.style.marginTop = "".concat(-.5 * o.height, "px")
    }
    ...
    function a(n, e) {
        if (n.Module) {
            var t = 100 * e;
            h.style.width = "".concat(t, "%"),
            m.innerHTML = "".concat(t << 0, "%"),
            w.a.fileSize && (m.innerHTML += " of ".concat(w.a.fileSize, "MB"));
            var o = {
                percentageDone: t
            };
            PokiSDK.gameLoadingProgress(o),
            e >= 1 && "done" !== f.className && (f.className = "done",
    ...
    function s() {
        ...
        y++,
        y >= n.length && (y = 0),
        g = setTimeout(s, w.a.commentChangeTime)) : p.innerHTML = ""
    }
    ...
    var d, u, f, h, m, p, g, w = t(0), v = t(1), y = 0;
    !function() {
        var n = document.createElement("div");
...
, function(n, e, t) {
    var o = function(n) {
        ...
        var p, g = Object.prototype, w = g.hasOwnProperty, v = "function" == typeof Symbol ? Symbol : {}, y = v.iterator || "@@iterator", b = v.asyncIterator || "@@asyncIterator", x = v.toStringTag || "@@toStringTag";
        n.wrap = e;
        ...
        return i.prototype = j.constructor = r,
        r.constructor = i,
        r[x] = i.displayName = "GeneratorFunction",
        ...
        ,
        n.mark = function(n) {
            return Object.setPrototypeOf ? Object.setPrototypeOf(n, r) : (n.__proto__ = r,
            x in n || (n[x] = "GeneratorFunction")),
        ...
        f.prototype = {
            ...
            reset: function(n) {
                ...
                !n)
                    for (var e in this)
                        "t" === e.charAt(0) && w.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = p)
            },
            stop: function() {
                this.done = !0;
