...
let data = [
    ...
    },
    {
        ...
        time: "< 1 min read",
        id: "2",
        text: "This update includes some small changes such as minor bug fixes and security updates. Read below for more details:<br><br><b>Security Updates</b><br>• Removed Adventure Capitalist as GitHub's Dependabot found <b>61 vulnerable dependencies</b> with some being critical.<br>ㅤ◦ I'm aware that this may of been actively exploited.<br><br><b>Other Changes</b><br>• Worked on the scaling on the home page, should look better on smaller/bigger resolution devices.<br>• Fixed a few grammar and spelling errors, but there's still probably a lot more.<br>• Changed how it detects if your in the iframe (to hide the scrollbar) because mobile performance was trash and I assumed it was from that. <br>• Experimenting with a few other scaling things cause it's still pretty bad, especially on mobile.<br><br><b>Known Issues</b><br>• When loading the site, you may see the site glitch before completely loading with no loading screen. (26911389)<br>• Scaling may be a problem with certain elements on bigger/smaller resolution devices. (34482888)<br>ㅤ◦ <b>Workaround:</b> Scale up/down the page using zoom. Not available on mobile.<br>• If you scroll down and reload, the loading screen doesn't fade out and is seen fading out at the top of the page. (49867091)<br>• Sometimes when clicking off the game splash screen thing, you would end up viewing a different game's splash screen. (44939979)<br>• On some devices, game descriptions might be too long that they get cut off, and/or the play button, at the bottom of the page.<br>ㅤ◦ <b>Workaround:</b> Scale the page down. Not available on mobile.<br>• None of the cloak icons show up. (52999265)<br><br><b>Resolved Issues</b><br>• Main website icon would not show up. (52999265-1)<br>ㅤ◦ <b>Solution:</b> Change the icon type to image/png.",
    },
    // {
    //     title: "",
    //     date: "",
