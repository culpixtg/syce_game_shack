...
const data = [
    ...
    },
    {
        ...
        id: "draw_the_hill",
        genre: "Arcade",
        description: "In this cool driving game, you your skills to draw a path for the car to drive through the level. Make sure you draw a steady path or else you'll end the level.",
